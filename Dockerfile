...
RUN yarn global add @angular-devkit/build-webpack

RUN yarn global add @angular-devkit/architect

RUN yarn global add @angular-devkit/core

RUN yarn global add @angular-devkit/schematics

RUN yarn global add @schematics/angular

RUN yarn global add @schematics/update
